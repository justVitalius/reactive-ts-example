...
player$.subscribe( calculatedPlayer => {
  const currentX = calculatedPlayer.x;
  console.log(map.slice(0, currentX).concat(cellPlayer).concat(map.slice(currentX + 1, map.length))); // tslint:disable-line
});
